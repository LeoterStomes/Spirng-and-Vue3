...
export function getCurrentUser(params, config = {}) {
  return request.get('/user/current', params, config)
}
...
export function updateUser(params, config = {}) {
  return request.put('/user/profile', params, config)
}
...
export function updatePassword(params, config = {}) {
  return request.put('/user/password', params, config)
}
...
export function getUserStatistics(config = {}) {
  return request.get('/user/statistics', null, config)
}
